    ...
    return runner.run_with(
        {
            ...
            ConfigurationOption{[&] (auto& option) { background_client.set_x_margin(option);},
                               "x-text-margin",     "Size of x-axis margin (in percentage of display width) for diagnostic", "0"},
            ConfigurationOption{[&] (auto& option) { background_client.set_y_margin(option);},
                               "y-text-margin",     "Size of x-axis margin (in percentage of display height) for diagnostic", "0"},
