...
* `config=<contents for ubuntu_core_kiosk.config>`
* `display=<contents for ubuntu_core_kiosk.display>`
...
# USE 'snap set ubuntu-core-kiosk config=...' INSTEAD
...
```yaml
$ snap set ubuntu-core-kiosk display="
layouts:
  default:
    cards:
    - card-id: 0
