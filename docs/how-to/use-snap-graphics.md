...
1. use [`bin/gpu-2604-wrapper`](https://github.com/canonical/gpu-snap/blob/main/bin/gpu-2604-wrapper) in your <code>{ref}`command-chain <snapcraft:app.command_chain>`</code>s:
