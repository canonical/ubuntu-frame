...
It does this by using a Snap "content interface", {ref}`graphics-core22 <the-graphics-core22-snap-interface>`, that allows alternative drivers providing the facilities to be used. By default, [Ubuntu Frame](https://snapcraft.io/ubuntu-frame) will use the [mesa-core22](https://snapcraft.io/mesa-core22) implementation of this interface which provides the Mesa drivers from the Ubuntu 22.04LTS Archive.
...
First we need an alternative `graphics-core22` provider. As you won't have access to a brand store we will use a parallel installation of a backport of a more recent version of Mesa, which serves the purpose of illustrating this functionality.

Packaging graphics drivers as a snap isn't something we discuss here. There's details of the requirements in {ref}`The graphics-core22 Snap interface <the-graphics-core22-snap-interface>`, and the [mesa-core22](https://snapcraft.io/mesa-core22) and [mesa-core22_kisak](https://snapcraft.io/mesa-core22_kisak) snaps can be used as reference examples.
...
snap install --channel beta/kisak mesa-core22_kisak
```
...
You can see what's connected to the graphics-core22 interface as follows:

```
snap interfaces | grep graphics-core22
mesa-core22:graphics-core22   ubuntu-frame,wpe-webkit-mir-kiosk
mesa-core22_kisak:graphics-core22  -
```
...
```
snap disconnect ubuntu-frame:graphics-core22
snap disconnect wpe-webkit-mir-kiosk:graphics-core22
snap connect ubuntu-frame:graphics-core22 mesa-core22_kisak
snap connect wpe-webkit-mir-kiosk:graphics-core22 mesa-core22_kisak
```
...
```
$ snap interfaces | grep graphics-core22
mesa-core22:graphics-core22   -
mesa-core22_kisak:graphics-core22  ubuntu-frame,wpe-webkit-mir-kiosk
```
