...
We also download an Ubuntu Core image from [https://cdimage.ubuntu.com/ubuntu-core/26/stable/current/](https://cdimage.ubuntu.com/ubuntu-core/26/stable/current/)

Now, uncompress the image and move it to a convenient location:

```
$ unxz ~/Downloads/ubuntu-core-26-amd64.img.xz
$ mv ~/Downloads/ubuntu-core-26-amd64.img ~/snap/qemu-virgil/common/
$ qemu-virgil -enable-kvm -m 512 -device virtio-vga,virgl=on\
 ...
 ~/snap/qemu-virgil/common/ubuntu-core-26-amd64.img
```
